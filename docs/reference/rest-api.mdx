...
Retrieved, never resident. This is what keeps the injected block
bounded by the *number of rules* rather than by how often they have
changed. Each amendment carries the previous value of every field it
touched, so the superseded text is recoverable without ever being
resident in anyone's context.
