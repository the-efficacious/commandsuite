...
export function Boot() {
  ...
  return (
    ...
    >
      <BrandMark size={56} stroke="var(--ef-text)" style="opacity:.85" />
      <div style="font-family:var(--ef-font-mono);font-size:11.5px;letter-spacing:.16em;text-transform:uppercase;color:var(--ef-text-muted);display:inline-flex;align-items:center;gap:10px">
        <span class="dot pulse" style="background:var(--ef-lamp-working)" />
      ...
      {stuck && (
        <div style="display:flex;flex-direction:column;align-items:center;gap:10px;margin-top:10px;max-width:24rem">
          <div
            ...
            style="font-family:var(--ef-font-mono);font-size:11.5px;letter-spacing:.14em;text-transform:uppercase;color:var(--ef-lamp-caution);gap:6px"
          >
