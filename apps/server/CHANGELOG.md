...
- Updated dependencies [[`a2cc68a`](https://github.com/the-efficacious/commandsuite/commit/a2cc68af186c8bcb661088efc7b26f914c7abd80), [`134f0f8`](https://github.com/the-efficacious/commandsuite/commit/134f0f8a17d990cc91b13ceb0d34616d86f96f81), [`7c03e4b`](https://github.com/the-efficacious/commandsuite/commit/7c03e4b4c10c4daa9bc419b9eae7adab9efaff7f), [`a2cc68a`](https://github.com/the-efficacious/commandsuite/commit/a2cc68af186c8bcb661088efc7b26f914c7abd80), [`134f0f8`](https://github.com/the-efficacious/commandsuite/commit/134f0f8a17d990cc91b13ceb0d34616d86f96f81), [`a2cc68a`](https://github.com/the-efficacious/commandsuite/commit/a2cc68af186c8bcb661088efc7b26f914c7abd80), [`a2cc68a`](https://github.com/the-efficacious/commandsuite/commit/a2cc68af186c8bcb661088efc7b26f914c7abd80), [`134f0f8`](https://github.com/the-efficacious/commandsuite/commit/134f0f8a17d990cc91b13ceb0d34616d86f96f81), [`a2cc68a`](https://github.com/the-efficacious/commandsuite/commit/a2cc68af186c8bcb661088efc7b26f914c7abd80), [`134f0f8`](https://github.com/the-efficacious/commandsuite/commit/134f0f8a17d990cc91b13ceb0d34616d86f96f81), [`a2cc68a`](https://github.com/the-efficacious/commandsuite/commit/a2cc68af186c8bcb661088efc7b26f914c7abd80), [`134f0f8`](https://github.com/the-efficacious/commandsuite/commit/134f0f8a17d990cc91b13ceb0d34616d86f96f81), [`a2cc68a`](https://github.com/the-efficacious/commandsuite/commit/a2cc68af186c8bcb661088efc7b26f914c7abd80)]:
  - csuite-core@0.8.0
  - csuite-sdk@0.8.0
...
- [#190](https://github.com/the-efficacious/commandsuite/pull/190) [`a39a46f`](https://github.com/the-efficacious/commandsuite/commit/a39a46f751b68556633440b1bbcadd254dd3e1a0) Thanks [@andrew-jon-p7a](https://github.com/andrew-jon-p7a)! - Transactional execution goes through the driver seam: `SqlDriver`
  ...
  uses the latter.
- Updated dependencies [[`a39a46f`](https://github.com/the-efficacious/commandsuite/commit/a39a46f751b68556633440b1bbcadd254dd3e1a0)]:
  - csuite-core@0.7.1
  - csuite-sdk@0.7.1
...
- Updated dependencies [[`4f09779`](https://github.com/the-efficacious/commandsuite/commit/4f0977937266b445265ded29af8deb3a0c16896f)]:
  - csuite-core@0.7.0
  - csuite-sdk@0.7.0
...
- [#185](https://github.com/the-efficacious/commandsuite/pull/185) [`c9e4a85`](https://github.com/the-efficacious/commandsuite/commit/c9e4a85707581d4325a24a17d4fbd880ea88136d) Thanks [@andrew-jon-p7a](https://github.com/andrew-jon-p7a)! - One push per objective creation. Initial watchers ride the `assigned`
...
- [#136](https://github.com/the-efficacious/commandsuite/pull/136) [`294d857`](https://github.com/the-efficacious/commandsuite/commit/294d857242d3e3cd47d4cef594c5193c30d1c773) Thanks [@andrew-jon-p7a](https://github.com/andrew-jon-p7a)! - feat(cli): drain-and-restart — on a `kind: 'instructions'` event the runner waits for the agent's next idle boundary, re-points ambient input at a buffer for the successor, gracefully stops the agent, refetches instructions, and respawns resuming the same conversation under the new system prompt (Claude session resume / codex thread resume). The watchdog's `stale` state no longer re-sends content — restart is the remediation; the resend is reserved for blocks that fell out entirely.

### Patch Changes

- [#136](https://github.com/the-efficacious/commandsuite/pull/136) [`294d857`](https://github.com/the-efficacious/commandsuite/commit/294d857242d3e3cd47d4cef594c5193c30d1c773) Thanks [@andrew-jon-p7a](https://github.com/andrew-jon-p7a)! - fix(server): confirm context-block presence from the captured conversation, not only the system projection — a block edited mid-session no longer re-sends on every captured request
...
- [#134](https://github.com/the-efficacious/commandsuite/pull/134) [`56affe5`](https://github.com/the-efficacious/commandsuite/commit/56affe5d3c8549ab3ff0c332f6257defc2f49b70) Thanks [@keencaliper](https://github.com/keencaliper)! - The context watchdog projects the process document's sent bytes rather
  than a normalised copy, and the runner's design comment no longer
  states the opposite of the shipped behaviour.

  Both were raised on [#130](https://github.com/the-efficacious/commandsuite/issues/130) and crossed with its merge, so 0.4.0 carries
  them.

  - **The projection trimmed the document; the runner does not.** The
    store refuses only text whose _trimmed_ value is empty — it does not
    ...
    invariant, but it now decides _whether_ to project, never _what_.
  ...
  - **A KNOWN GAP comment survived the closing of its own gap.**
    ...
    and that a lost document returns only at the next runner start. [#130](https://github.com/the-efficacious/commandsuite/issues/130)
  ...
  projection is built from the _current_ stored document, an agent
  ...
  system projection being unobservable ([#118](https://github.com/the-efficacious/commandsuite/issues/118)).
...
- [#116](https://github.com/the-efficacious/commandsuite/pull/116) [`cec437e`](https://github.com/the-efficacious/commandsuite/commit/cec437e801958baca0bc5b5f19c48301b89bcb16) Thanks [@sureforge](https://github.com/sureforge)! - Detect persistent briefing blocks missing from captured system instructions, measure presence per block, and re-send missing blocks on the next turn.
